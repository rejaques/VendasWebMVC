...
namespace VendasWebMVC
{
    public class Startup
    {
        ...
        {
            var enBrasil = new CultureInfo("pt-BR");
            var localOptions = new RequestLocalizationOptions
            {
                DefaultRequestCulture = new RequestCulture(enBrasil),
                SupportedCultures = new List<CultureInfo> { enBrasil },
                SupportedUICultures = new List<CultureInfo> { enBrasil }
            };
